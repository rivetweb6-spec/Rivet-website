          ...
          {services.map((s) => {
            ...
            return (
              <StaggerItem key={s.slug}>
                <div className="group h-full rounded-[4px] border border-border/70 bg-canvas p-9 transition-all duration-700 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[var(--shadow-lg)]">
